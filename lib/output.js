...
const is = require('./is');
let sharp = require('../build/Release/sharp.node');

function reloadSharp() {
  delete require.cache[require.resolve('../build/Release/sharp.node')];
...
function gif (options) {
  ...
  trySetAnimationOptions(options, this.options);
  if (!(is.object(options) && options.optimize === false)) {
    this.options.optimizeGif = false;
  }
